...
if f1 == "project introduction":
    ...
    st.write("Our project aims at designing a Food Wastage Management System which clode effiectively manage food wasted in Hotels,Resturants and supermarket.")
...
# Update
    ...
    st.subheader(f"Update {dataset_option}")
    st.dataframe(df)
    if len(df) > 0:
